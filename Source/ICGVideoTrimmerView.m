...
- (void)resetSubviews
{
    ...
    CGFloat rightViewFrameX = (CGRectGetWidth(self.frameView.frame) + (2 * self.thumbWidth) ) < CGRectGetWidth(self.frame) ? CGRectGetMaxX(self.frameView.frame) : CGRectGetWidth(self.frame) - self.thumbWidth;
